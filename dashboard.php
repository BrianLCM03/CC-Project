            ...
            <div class="col-md-6">
                <div class="card shadow-lg " >
                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <p class="card-text">-Simple and Intuitive Interface</p>
                        <p class="card-text">-Make managing your tasks effortless and efficient.</p>
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <a href="Homepage.php">
                                <button type="button" class="btn btn-outline-success shadow">Get Started</button>
                            </a>
                        </div>
                    </div>
                </div>
